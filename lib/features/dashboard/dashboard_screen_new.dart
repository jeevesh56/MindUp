...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  // Removed unused _iconForStage helper
  ...
  void _quickMoodLog(int score) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Mood logged: ${_getMoodEmoji(score)}'),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icons[stage - 1], color: Colors.green, size: 32),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: Theme.of(
                      context,
                    ).textTheme.titleMedium?.copyWith(color: Colors.green[600]),
                  ),
            ...
            Icon(Icons.arrow_forward_ios, color: Colors.green[400], size: 20),
          ],
        ),
      ),
    );
              ...
              Row(
                ...
                children: [
                  ...
                  _MoodEmoji(
                    ...
                    score: 7,
                    label: 'Happy',
                    onTap: () => onMoodSelected(7),
                  ),
                  _MoodEmoji(
                    emoji: '😄',
                    score: 9,
                    label: 'Great',
                    onTap: () => onMoodSelected(9),
                  ),
                ],
              ),
              const SizedBox(height: 24),
